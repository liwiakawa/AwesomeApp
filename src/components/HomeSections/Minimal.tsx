...
const Minimal: FC = () => {
  return (
    <View style={{ flex: 1 }}>
        ...
        <SectionTitle>Minimalism</SectionTitle>
      </View>
      <SectionContainer
        horizontal={true}
        pagingEnabled={true}
      ...
      >
        <LeftArrowContainer />
        <Box>
          <CustomImage source={require("../../assets/7.jpg")} />
        ...
        <Box>
          <CustomImage source={require("../../assets/8.jpg")} />
          <BoxTitle>Introduction</BoxTitle>
          <Time>3-5 min read</Time>
          <BoxTxt>
            The truth is that every single individual can be creative. You
        ...
        <Box>
          <CustomImage source={require("../../assets/9.jpg")} />
          <BoxTitle>Introduction</BoxTitle>
          <Time>3-5 min read</Time>
          <BoxTxt>
            The truth is that every single individual can be creative. You
